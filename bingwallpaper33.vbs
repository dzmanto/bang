...
REM Set filetxt = filesys.OpenTextFile("desc.txt", 2, True) 
REM filetxt.Write desc
REM filetxt.Close

REM WshShell.Run "powershell.exe -nologo -ExecutionPolicy Bypass -command .\dumpstr.ps1 {" + desc + "}", 0, TRUE

REM write pwd
pwd=WshShell.CurrentDirectory
imgpath = pwd + "\bingimagean.bmp"
Set filesys = CreateObject("Scripting.FileSystemObject")
Set filetxt = filesys.OpenTextFile("pwd.txt", 2, True) 
filetxt.Write imgpath
filetxt.Close 
...
WshShell.Run "powershell.exe -nologo -ExecutionPolicy Bypass -command .\rotanconv2.ps1 {" + desc + "}", 0, TRUE
WshShell.Run "powershell.exe -nologo -ExecutionPolicy Bypass -command .\powershell_change_background.ps1", 0, TRUE
